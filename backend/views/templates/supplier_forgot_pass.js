module.exports = function (data) {
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
          ...
          <title>${process.env.APPLICATION_NAME} - Password Reset Request</title>
            <style type="text/css">
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        background: linear-gradient(to right, #fff 0%, #fff 100%) !important;">
                                                          ...
                                                          <img align="center" alt="Logo" class="kmImage" src="${process.env.SOURCE_NOW_MAIL_LOGO}" width="100" style="border:0;height:auto;line-height:100%;outline:none;text-decoration:none;padding-bottom:0;display:inline;vertical-align:bottom;max-width:199px;" />
                                                        </td>
                                                      </tr>
                                                    </tbody>
                                                  </table>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="kmTextContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#000;font-family:Helvetica, Arial;font-size:14px;line-height:150%;text-align:left;padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                          ...
                                                          <p style="margin:0;padding-bottom:1em"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size: 16px;">Hi <strong></strong>,</span></span></p>
                                                          <p style="margin:0;padding-bottom:1em">It appears that you've requested to reset your password for your account.</p>
                                                          <p style="margin:0;padding-bottom:1em">Please click on the link below to proceed with resetting your password </p>

                                                          <p style="text-align: center;margin:0;padding-bottom:1em">
                                                            <span style="font-family:arial,helvetica,sans-serif;">
                                                              <span style="font-size: 16px;">
                                                                <a href="${process.env.SUPPLIER_RESET_USER_PASSWORD}${data.send_token}" target="_blank" class="btn btn-default" style="word-wrap:break-word;color:#0000cd;font-weight:normal;text-decoration:underline">Reset Password</a>
                                                              </span>
                                                            </span>
                                                          </p>

                                                          <p style="margin:0;padding-bottom:1em">If you did not initiate this request, please reply to this email immediately so we can further assist you in securing your account.</p>
                                                          ...
                                                          <p style="margin:0;padding-bottom:0"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size: 16px;">${process.env.APPLICATION_NAME}</span></span></p>
