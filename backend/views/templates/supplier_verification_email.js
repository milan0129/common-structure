                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="kmTextContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#000;font-family:Helvetica, Arial;font-size:14px;line-height:150%;text-align:left;padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                          ...
                                                          <p style="margin:0;padding-bottom:1em">It appears that you've requested to verify your email for your account.</p>
                                                          <p style="margin:0;padding-bottom:1em">Please click on the link below to proceed with verify your email </p>

                                                          <p style="text-align: center;margin:0;padding-bottom:1em">
                                                            <span style="font-family:arial,helvetica,sans-serif;">
                                                              <span style="font-size: 16px;">
                                                                <a href="${process.env.SUPPLIER_VERIFY_USER_EMAIL}${data.send_token}" target="_blank" class="btn btn-default" style="word-wrap:break-word;color:#0000cd;font-weight:normal;text-decoration:underline">Verify your email</a>
                                                              </span>
                                                            </span>
                                                          </p>
